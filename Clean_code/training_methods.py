...
class F_theta:
    ...
    def __init__(self,
        ...
        self.dropout_01 = Dropout(0.1, name='dropout_01') 
        self.dropout_11 = Dropout(0.1, name='dropout_11') 
        self.dropout_21 = Dropout(0.1, name='dropout_21') 
        self.dropout_31 = Dropout(0.1, name='dropout_31') 

        self.dropout_02 = Dropout(0.1, name='dropout_02') 
        self.dropout_12 = Dropout(0.1, name='dropout_12') 
        self.dropout_22 = Dropout(0.1, name='dropout_22') 
        self.dropout_32 = Dropout(0.1, name='dropout_32') 
